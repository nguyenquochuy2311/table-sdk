...
export var CalculationType = /* @__PURE__ */ ((CalculationType2) => {
...
export var CONDITION_OPERATOR = /* @__PURE__ */ ((CONDITION_OPERATOR2) => {
...
export var LOOKUP_FILTER_VALUE_TYPE = /* @__PURE__ */ ((LOOKUP_FILTER_VALUE_TYPE2) => {
...
export var LOGICAL_OPERATOR = /* @__PURE__ */ ((LOGICAL_OPERATOR2) => {
...
export const FieldLookupParamsValidator = z.object({
  lookup: z.object({
    ...
    operator: z.nativeEnum(CalculationType).default("not-apply" /* NotApply */),
    filter: z.object({
      options: z.array(conditionLookupValidator).min(0).max(5),
      conditions: z.record(
        z.union([z.literal("and"), z.literal("or")]),
        z.array(z.union([conditionLookupValidator, z.any()])).min(0).max(5)
      ),
