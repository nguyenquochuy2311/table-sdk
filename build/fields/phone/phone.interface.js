...
var phone_interface_exports = {};
__export(phone_interface_exports, {
...
module.exports = __toCommonJS(phone_interface_exports);
...
var FieldPhoneInitialDataValidator = import_zod.z.object({
  phone: import_zod.z.string().regex(phoneRegex, "Invalid Number!").nullable().default(null),
  countryCode: import_zod.z.enum((0, import_lodash.map)(PHONE_COUNTRIES, "code")).nullable().default(null)
}).nullable().default(null);
var FieldPhoneParamsValidator = import_zod.z.object({
  countryCode: import_zod.z.enum((0, import_lodash.map)(PHONE_COUNTRIES, "code")).nullable(),
